...
describe('attendance repair view', () => {
  ...
  it('loads repairable references and submits manual repair request', async () => {
    ...
    await wrapper.get('[data-testid="attendance-repair-page-check-time"]').setValue('2026-04-12 10:07:46')
    await wrapper.get('[data-testid="attendance-repair-page-reason"]').setValue('我需要补卡')
    ...
    expect(wrapper.text()).toContain('补卡申请已提交，请等待后续处理结果')
  })
})
