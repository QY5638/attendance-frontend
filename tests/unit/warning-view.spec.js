...
describe('warning view', () => {
  ...
  it('loads warning list on mount and renders list fields', async () => {
    ...
    expect(wrapper.get('[data-testid="warning-dashboard"]').text()).toContain('处理进度')
    ...
    expect(wrapper.get('[data-testid="warning-dashboard"]').text()).toContain('高风险人员')
    expect(wrapper.get('[data-testid="warning-dashboard"]').text()).toContain('张三（zhangsan）')
    expect(wrapper.get('[data-testid="warning-dashboard"]').text()).toContain('重点人员')
  ...
  it('opens portrait dialog and loads warning archive by user id', async () => {
    ...
    expect(wrapper.get('[data-testid="warning-portrait-dialog"]').text()).toContain('近期记录')
