...
describe('statistics view', () => {
  ...
  it('loads statistics page sections', async () => {
    ...
    expect(wrapper.get('[data-testid="statistics-exception-types"]').text()).toContain('多次迟到')
    expect(wrapper.get('[data-testid="statistics-exception-types"]').text()).toContain('多次重复打卡')
    ...
    expect(wrapper.get('[data-testid="statistics-continuous-patterns"]').text()).toContain('多次迟到')
    expect(wrapper.get('[data-testid="statistics-continuous-patterns"]').text()).toContain('多次重复打卡')
