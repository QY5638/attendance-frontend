...
describe('statistics view', () => {
  ...
  it('loads statistics page sections', async () => {
    ...
    expect(wrapper.get('[data-testid="statistics-runtime-events"]').text()).toContain('关键事件总数')
    expect(wrapper.get('[data-testid="statistics-runtime-events"]').text()).toContain('12')
    expect(wrapper.get('[data-testid="statistics-runtime-events"]').text()).toContain('活体验证事件')
